...
export default function Dashboard() {
    const { fetchFiles, Files, Stories, fetchStories } = useAuth();
    ...
    const filteredFiles = Files?.filter(
        (file) =>
            ...
            (Array.isArray(file?.tags) && file.tags.some((tag) => tag?.toLowerCase().includes(searchQuery?.toLowerCase()))) ||
                    ...
                    <TabsContent value="upload" className="space-y-6 border-none">
                        <Card className="border-none">
                            <CardHeader className="text-left">
                                ...
                                <CardDescription>
                                    Upload videos and photos to start building your AI-powered
                                    stories
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                    ...
                                    <div className="space-y-4 mt-8">
                                        ...
                                        <div className="grid gap-4">
                                            {Files.map((file) => (
                                                <Card
                                                    key={file.id}
                                                    className="p-4 border-none hover:scale-[1.01]"
                                                >
                                                    <div className="flex items-start space-x-4">
                                                        <img
                                                            src={
                                                                file.file_type == "image"
                                                                    ? `${IMAGE_BASE_URL}${file.thumbnail_path}` ||
                                                                    "/videoPlayer.png"
                                                                    : "/videoPlayer.png"
                                                            }
                                                            alt={file.thumbnail_path}
                    ...
                    <TabsContent value="search" className="space-y-6">
                        <Card className="border-none">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Find specific moments using keywords actions
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-4">
                                    <div className="relative">
                                        ...
                                        <Input
                                            placeholder="Search for actions or keywords..."
                                            value={searchQuery}
                                        ...
                                        <div className="space-y-4 border-none">
                                            ...
                                            {filteredFiles?.length === 0 ? (
                                                <div className="text-center py-8 text-gray-500">
                                                    ...
                                                    <p className="text-sm">
                                                        Try searching for beach, birthday, or family
                                                    </p>
                                                </div>
                                            ) : (
                                                <div className="grid gap-4">
                                                    {filteredFiles?.map((file) => (
                                                        <Card
                                                            key={file.id}
                                                            className="p-4 hover:shadow-md transition-shadow hover:cursor-pointer border-none"
                                                        >
                                                            <div className="flex items-start space-x-4">
                                                                <img
                                                                    src={
                    ...
                    <TabsContent value="generate" className="space-y-6">
                        <Card className="border-none">
                            <CardHeader className="text-left">
                                ...
                                <CardDescription>
                                    Tell our AI what story you want to create from your footage
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <StoryGenerator />
                                ...
                                {Array.isArray(Stories) && Stories?.length == 0 ? (
                                    <div className="text-center py-12">
                                        ...
                                        <p className="text-gray-600 mb-4">
                                            Generate your first AI story to get started
                                        </p>
                                        <Button
                                            onClick={() =>
                                    ...
                                    <div className="grid gap-6 ">
                                        {Array.isArray(Stories) &&
                                            Stories?.map((story, index) => (
                                                ...
                                                >
                                                    <div className="flex">
                                                        {story?.uploadFile && <div>
                                                            <img
                                                                src={
                                                                    story?.uploadFile?.split('.')[1].includes("mp4") && story?.uploadFile ? "/videoPlayer.png" : `${IMAGE_BASE_URL}${story.uploadFile}`
                                                                }
                                                                alt={story?.title}
                                                        ...
                                                        <div className="flex-1 p-6">
                                                            <div className="flex items-start justify-between mb-3">
                                                                <div>
                                                                    <h3 className="text-xl text-left font-semibold mb-1">
                                                                        {story?.title}
                                                                    </h3>
                                                            ...
                                                            <div className="flex space-x-3">
                                                                <Button
                                                                    className="bg-gradient-to-r cursor-pointer from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white"
